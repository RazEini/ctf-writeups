...
| :--- | :--- | :--- | :--- | :--- |
| **Binary Exploitation** | Picker IV | Medium | Function Pointer Redirection, Symbol Lookup, `pwntools` | [View Writeup](./ctf-writeups/Binary_Exploitation/Picker_IV/) |
| **Binary Exploitation** | buffer overflow 0 | Easy | Stack Buffer Overflow, Unsafe `gets()`, SIGSEGV Handler | [View Writeup](./ctf-writeups/Binary_Exploitation/buffer_overflow_0/) |
